...
Called every time the display structure or r_refdef changes.
...
void R_DrawEntitiesOnList(void)
{
	...
	for (i = 0; i < cl_numvisedicts; i++)
	{
		...
		if (currententity == &ClientEntities[cl.viewentity])
...
void R_RenderView_(void)
{
	...
	if (!ClientEntities[0].model || !cl.worldmodel)
	...
	// AngryCPPCoder: Viewmodel == weapon
	// Below code would draw the weapon
	R_DrawViewModel();
